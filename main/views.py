...
def chat_with_ai(request):
    try:
        ...
        messages = [
            ...
            Abdullah Alghamdi is a Computer Science graduate from Umm Al-Qura University with experience in data analysis, Power BI dashboards, Django web development, and teaching Python. He worked as a Data Analyst at Kidana and National Real Estate Registry, interned in Django development at Tuwaiq Academy,
            ...
            Abdullah also holds the P-CEP (Certified Entry-Level Python Programmer) certificate.
